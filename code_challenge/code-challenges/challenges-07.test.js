...
const replaceZeros = (string) => {
  // Solution code here...
  const st = string.replace(/[0]/g, "zero");
  return st;
};
...
const addOne = (arr) => {
  // Solution code here...
  const array = arr.map((number) => number + 1);
  return array;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  const array = arr.map((string) => string + "?");
  return array;
};
...
const forLoopTwoToThe = (arr) => {
  // Solution code here...
  let array = [];
  arr.forEach((e) => array.push(Math.pow(2, e)));
  return array;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  const array = arr.map((e) => Math.pow(2, e));
  return array;
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  const array = arr.map((obj) => (obj.ability.name));
  return array;
