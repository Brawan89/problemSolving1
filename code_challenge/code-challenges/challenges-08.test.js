...
const typeNum = (arr) => {
  // Solution code here...
  const array = arr.filter((e) => typeof e == "number");
  return array;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  const array = arr.filter((e) => e.includes("and"));
  return array;
};
...
const oddValues = (arr) => {
  // Solution code here...
  const array = arr.filter((e) => e % 2 !== 0);
  return array;
};
...
const filterStringsWithVowels = (arr) => {
  ...
  const g = /[a|e|i|o|u]/i;
  const array = arr.filter((e) => g.test(e));
  return array;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const array = arr.filter((e) => !forbiddenValues.includes(e));
  return array;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  const array = arr.filter((e) => e.baseStat > minBaseStat);
  return array;
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  const array = arr
    .filter((e) => e.baseStat > minBaseStat)
    .map((e) => e.stat.name);
  return array;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  const array = arr.filter((e) => !e.children);
  return array;
};
